...
let UsersController = class UsersController {
    ...
    async setAdmin(req, userId, isAdmin) {
        const user = req.user;
    ...
    async setVerified(req, userId, isVerified) {
        const user = req.user;
        const isUserAdmin = await this.usersService.isAdmin(user.id);
        if (!isUserAdmin) {
            throw new common_1.ForbiddenException('Admin access required');
    ...
    async deleteMyAccount(req, res, password) {
        const user = req.user;
        if (!password) {
...
__decorate([
    ...
    __param(2, (0, common_1.Body)('is_admin')),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('id')),
    __param(2, (0, common_1.Body)('is_verified')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, Boolean]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "setVerified", null);
__decorate([
